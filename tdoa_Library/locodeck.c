...
static lpsAlgoOptions_t algoOptions = {
  ...
  // lpsMode_auto is an impossible mode which forces initialization of the requested mode at startup
...
// This function is called from the memory sub system that runs in a different task, protect it from concurrent calls from this task
